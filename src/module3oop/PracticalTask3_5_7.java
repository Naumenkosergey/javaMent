...
import module3oop.filtertexttask.*;

public class PracticalTask3_5_7 {

/*Пришло время попробовать реализовать иерархию классов определенного вида и решить конкретную задачу.
Представим, вы делаете систему фильтрации комментариев на каком-то веб-портале, будь то новости, видео-хостинг, а
...
каких-либо ключевых слов (в случае спама мы получаем их из конструктора, в случае негативного текста мы заранее
знаем набор грустных смайликов) и в случае нахождения одного из ключевых слов возвращают
...
текста. checkLabels должен возвращать первую не-OK метку в порядке данного набора анализаторов, и OK, если
все анализаторы вернули OK.
...
*/
    ...
    public static void main(String[] args) {
        TextAnalyzer negativeText = new NegativeTextAnalyzer();
        String[] mas = new String[]{"Купи", "подпишись", "закажи"};
//        TextAnalyzer spamText = new SpamAnalyser("Купи", "подпишись", "закажи");
        TextAnalyzer spamText = new SpamAnalyzer(mas);
        TextAnalyzer longText = new TooLongTextAnalyzer(10);
        TextAnalyzer[] analyzers = {negativeText, spamText, longText};

        checkLabels(analyzers, "И во-вторых, если таких версий требовалось создавать слишком много или их максимальное " +
                "коли");
    }
